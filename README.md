...
This is a [Lift](http://www.liftweb.net "Lift") based web application. It's a dictionary of Functional Programming terms where each term can have multiple descriptions. The users can add new terms or descriptions to existing terms. The users can vote on the descriptions so the best ones shows up first. 
